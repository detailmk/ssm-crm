...
<table id="dg" class="easyui-datagrid"
       ...
       url="${ctx}/customer/selectCustomerByParams" fit="true" toolbar="#tb">
    <thead frozen="true">
    <tr>
    ...
    <tr>
        ...
        <th align="center" data-options="field:'state',width:80,formatter:formatterState">状态</th>
...
<div id="tb">
    ...
    <a href="javascript:openCustomerOtherInfo('历史订单查看',3)"
       class="easyui-linkbutton" iconCls="icon-lsdd" plain="true">历史订单查看
    </a>
    <br/>
    客户名称:<input type="text" id="cusName"/>
    客户编号: <input type="text" id="khno"/>
    法人: <input type="text" id="fr"/>
    <a href="javascript:selectCustomersByParams()" class="easyui-linkbutton" iconCls="icon-search" plain="true">搜索</a>
</div>
...
,textField:'trueName',url:'${ctx}/user/selectCustomerList'"/>&nbsp;
                    <font color="red">*</font>
                </td>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td>客户等级：</td>
                <td>
                    <input class="easyui-combobox" id="level" name="level"
                           panelHeight="auto"
                           editable="false" valueField="dataDicValue"
                           textField="dataDicValue"
                           url="${ctx}/datadic/selectDatadicByDataDicName?dataDicName=客户等级"/>&nbsp;<font color="red">*</font>
                </td>
            </tr>
            <tr>
                <td>客户满意度：</td>
                ...
                <td>客户信用度</td>
                <td>
                    <select class="easyui-combobox" id="xyd" name="xyd"
