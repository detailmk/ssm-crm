...
<table id="dg" class="easyui-datagrid"
       ...
       url="${ctx}/role/selectRoleByParams" fit="true" toolbar="#tb">
    <thead>
    <tr>
...
<div id="tb">
    ...
    <a href="javascript:selectRolesByParams()" class="easyui-linkbutton" iconCls="icon-search" plain="true">搜索</a>
</div>
...
<div id="dlg" class="easyui-dialog" title="添加角色" closed="true"
    ...
    <form id="fm" method="post">
        角色名:<input type="text" class="easyui-validatebox" required="required" id="roleName02"
                   name="roleName"/><br/><br/>
