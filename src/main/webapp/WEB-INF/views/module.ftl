...
<table id="dg" class="easyui-datagrid"
       ...
       url="${ctx}/module/selectModuleByParams" fit="true" toolbar="#tb">
    <thead>
    <tr>
        ...
        <th field="grade" width="100" align="center" formatter="formatGrade">层级</th>
...
<div id="tb">
    ...
    上级菜单id:<input type="text" id="parentId"/>
    层级:
    ...
    <a href="javascript:selectModulesByParams()" class="easyui-linkbutton" iconCls="icon-search" plain="true">搜索</a>
</div>
...
<div id="dlg" class="easyui-dialog" title="添加模块" closed="true"
    ...
    <form id="fm" method="post">
        模块名称:<input type="text" class="easyui-validatebox" required="required" id="moduleName02"
                    name="moduleName"/><br/><br/>
        权限码:<input type="text" id="optValue02" class="easyui-validatebox" name="optValue"
        ...
        <div id="parentMenu">
            上级菜单:<input id="parentId02" class="easyui-combobox"
                        name="parentId" panelHeight="auto" editable="false"/><br/><br/>
        </div>
