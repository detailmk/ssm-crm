...
<table id="dg" class="easyui-datagrid"
       ...
       url="${ctx}/customerServe/selectCustomerServeByParams?state=1"
       fit="true" toolbar="#tb">
    <thead>
    <tr>
...
<div id="tb">
    <a href="javascript:openCustomerServeDialog('服务分配')"
            ...
            <tr>
                ...
                <td>
                    <select name="assigner" class="easyui-combobox"
                            url="${ctx}/user/selectCustomerList" valueField="trueName"
...
<div id="dlg-buttons">
    <a href="javascript:updateCustomerServe()"
