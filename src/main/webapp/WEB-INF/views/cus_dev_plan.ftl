...
<head>
<#include "common.ftl" >
    <script type="text/javascript" src="${ctx}/js/cus_dev_plan.js"></script>
</head>
<body style="margin: 1px">
<table id="dg"  class="easyui-datagrid"
        pagination="true" rownumbers="true"
       url="${ctx}/saleChance/selectSaleChanceByParams?state=1" fit="true" toolbar="#tb" singleSelect="true">
    <thead>
    <tr>
...
<div id="tb">
    ...
    <a href="javascript:selectSaleChancesByParams()" class="easyui-linkbutton" iconCls="icon-search" plain="true">搜索</a>
</div>
