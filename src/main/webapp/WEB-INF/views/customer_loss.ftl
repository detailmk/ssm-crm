...
<head>
    <#include "common.ftl" >
    <script type="text/javascript" src="${ctx}/js/customer_loss.js"></script>
</head>
<body style="margin: 1px">
<table id="dg" class="easyui-datagrid"
       pagination="true" rownumbers="true"
       url="${ctx}/customerLoss/selectCustomerLossByParams" fit="true" toolbar="#tb">
    <thead>
    <tr>
        <th field="cb" checkbox="true" align="center"></th>
        <th field="id" width="50" align="center">编号</th>
        <th field="cusName" width="180" align="center">客户名称</th>
        <th field="cusNo" width="180" align="center">客户编号</th>
        <th field="cusManager" width="80" align="center">客户经理</th>
        ...
        <th field="op" width="100" align="center" formatter="formateOp">操作</th>
    </tr>
    </thead>
</table>
<div id="tb">
    ...
    <a href="javascript:selectCustomerLossByParams()" class="easyui-linkbutton" iconCls="icon-search"
       plain="true">搜索</a>
</div>
