...
<div region="west" style="width: 200px" title="导航菜单" split="true">
    <div class="easyui-accordion" data-options="fit:true,border:false">
        <!-- ‘??’ 判断左侧变量是否丢失，相当于java中的null判断，或者这个变量未定义 -->
        <#if permissions??>
            <!-- ‘?’ 判断空字符串 空list 空map；‘!’ 给变量一个默认值 -->
            <#if permissions?seq_contains("10")>
                <div title="营销管理" data-options="selected:true,iconCls:'icon-yxgl'" style="padding: 10px">
                    <#if permissions?seq_contains("1010")>
                        <a href="javascript:openTab('营销机会管理','saleChance/index/0','icon-yxjhgl')"
                           class="easyui-linkbutton"
                           data-options="plain:true,iconCls:'icon-yxjhgl'" style="width: 150px">营销机会管理</a>
                    </#if>
                    <#if permissions?seq_contains("1020")>
                        <a href="javascript:openTab('客户开发计划','saleChance/index/1','icon-khkfjh')"
                           class="easyui-linkbutton"
        ...
        <div title="客户管理" data-options="iconCls:'icon-khgl'" style="padding:10px;">
            <a href="javascript:openTab('客户信息管理','customer/index/0','icon-khxxgl')" class="easyui-linkbutton"
        ...
        <div title="系统管理" data-options="iconCls:'icon-item'" style="padding:10px">
            ...
            <a href="javascript:openTab('模块管理','module/index','icon-user')" class="easyui-linkbutton"
            ...
            <a href="javascript:userLogout();" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-exit'"
...
<div id="dlg" class="easyui-dialog" style="width:400px;height:250px;padding: 10px 20px"
    ...
    <form id="fm" method="post">
        <table cellspacing="8px">
            ...
            <tr>
                <td>原密码：</td>
                <td><input type="password" id="oldPassword" name="oldUserPwd" class="easyui-validatebox" required="true"
                           style="width: 200px"/></td>
            </tr>
            <tr>
                <td>新密码：</td>
                <td><input type="password" id="newPassword" name="newUserPwd" class="easyui-validatebox" required="true"
                           style="width: 200px"/></td>
            </tr>
            <tr>
                <td>确认新密码：</td>
                <td><input type="password" id="confirmPassword" name="confirmUserPwd" class="easyui-validatebox"
