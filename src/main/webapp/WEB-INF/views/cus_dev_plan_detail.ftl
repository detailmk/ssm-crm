...
<body style="margin: 15px">
    ...
    <table id="dg" title="开发计划项" style="width:700px;height: 300px;"
        ...
        <tr>
            ...
            <th field="planDate" name="planDate"  width="100"   editor="{type:'datebox',options:{required:true,editable:false}}">日期</th>
    ...
    <script type="text/javascript" src="${ctx}/js/cus_dev_plan_detail.js"></script>
